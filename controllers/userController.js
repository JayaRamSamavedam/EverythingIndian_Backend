...
export const userLogin = async (req, res) => {
  ...
  try {
    ...
    //     // 'type=ninja; Path=/'
    // ]);
    res.setHeader('Set-Cookie', `jwt=${refreshToken}; SameSite=None; Max-Age=86400; Path=/; Domain=localhost`).status(200).json({ message: "User login successfully done", accessToken:accessToken });
      } else {
